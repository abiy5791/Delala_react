        ...
        <div className="overflow-x-auto">
          ...
          <Link to="/view_houses">
            <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white">
              ...
              <span className="hidden xs:block ml-2">view houses</span>
            </button>
          </Link>
          <Link to="/add_houses">
            <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white">
              ...
              <span className="hidden xs:block ml-2">Add houses</span>
            </button>
          </Link>
          <Link to="/view_labours">
            <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white">
              ...
              <span className="hidden xs:block ml-2">view labours</span>
            </button>
          </Link>
          <Link to="/add_labours">
            <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white">
              ...
              <span className="hidden xs:block ml-2">Add labours</span>
            </button>
          </Link>
          <Link to="/view_others">
            <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white">
              ...
              <span className="hidden xs:block ml-2">view others</span>
            </button>
          </Link>
          <Link to="/add_others">
            <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white">
              ...
              <span className="hidden xs:block ml-2">Add others</span>
            </button>
          </Link>
        </div>
      </div>
